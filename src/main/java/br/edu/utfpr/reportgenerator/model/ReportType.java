...
public enum ReportType {
    CHAMADA(
            ...
            4. O cabeçalho do CSV DEVE conter EXATAMENTE os seguintes campos:
    ...
    LISTA_ESPERA(
            ...
            3. O cabeçalho do CSV DEVE conter EXATAMENTE os seguintes campos, na ordem correta:
               Campus;Curso;Turno;Inscrição;Nome;Situação do requerimento de matrícula;Nota final;Class ACP1;Cota do candidato;Class LI_EPP2;Class LI_PCDP3;Class LI_QP4;Class LI_PPIP5;Class LB_EPP6;Class LB_PCDP7;Class LB_QP8;Class LB_PPIP9
            """
    ),
    MAIOR_MENOR_NOTA(
            ...
            2. O arquivo CSV deve ser salvo com codificação ISO-8859-1 e delimitador ponto e vírgula (;).
            3. O cabeçalho do CSV DEVE conter EXATAMENTE os seguintes campos:
    ...
    VAGAS_DISPONIVEIS(
            ...
            2. O arquivo CSV deve ser salvo com codificação ISO-8859-1 e delimitador ponto e vírgula (;).
            3. O cabeçalho do CSV DEVE corresponder aos campos esperados pelo relatório.
            4. ATENÇÃO: O relatório 'VagasDisponiveisCursos.jrxml' espera os campos:
               Campus;Grau;Curso;Turno;Cota;Maior Nota;Menor Nota
               Por favor, ajuste seu CSV para que o cabeçalho corresponda a estes campos.
            """
    );
